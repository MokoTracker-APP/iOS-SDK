...
+ (void)readScanIntervalParamsWithSucBlock:(nonnull void (^)(id returnData))sucBlock
                               failedBlock:(nonnull void (^)(NSError *error))failedBlock {
...
+ (void)readButtonResetStatusWithSucBlock:(nonnull void (^)(id returnData))sucBlock
                              failedBlock:(nonnull void (^)(NSError *error))failedBlock {
    [centralManager addTaskWithTaskID:mk_taskReadButtonResetStatusOperation
                 characteristic:centralManager.peripheral.custom
                       resetNum:NO
...
+ (void)readTrackingDataFormatWithSucBlock:(nonnull void (^)(id returnData))sucBlock
                               failedBlock:(nonnull void (^)(NSError *error))failedBlock {
    [centralManager addTaskWithTaskID:mk_taskReadTrackingDataFormatOperation
                       characteristic:centralManager.peripheral.custom
                             resetNum:NO
...
+ (void)readConnectionNotificationStatusWithSucBlock:(nonnull void (^)(id returnData))sucBlock
                                         failedBlock:(nonnull void (^)(NSError *error))failedBlock {
    [centralManager addTaskWithTaskID:mk_taskReadConnectionNotificationStatusOperation
                       characteristic:centralManager.peripheral.custom
                             resetNum:NO
...
+ (void)readStorageDataNumberWithSucBlock:(nonnull void (^)(id returnData))sucBlock
                              failedBlock:(nonnull void (^)(NSError *error))failedBlock {
    [centralManager addTaskWithTaskID:mk_taskReadStorageDataNumberOperation
                       characteristic:centralManager.peripheral.custom
                             resetNum:NO
...
+ (void)readLowBatteryReminderRulesWithSucBlock:(nonnull void (^)(id returnData))sucBlock
                                    failedBlock:(nonnull void (^)(NSError *error))failedBlock {
    [centralManager addTaskWithTaskID:mk_taskReadLowBatteryReminderRulesOperation
                       characteristic:centralManager.peripheral.custom
                             resetNum:NO
