...
@class MKTrackerModel,CBCentralManager;

@protocol MKTrackerCentralManagerScanDelegate <NSObject>
...
@interface MKTrackerCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>

@property (nonatomic, weak)id <MKTrackerCentralManagerScanDelegate>delegate;
