...
#pragma mark - Read
    ...
    mk_taskReadButtonResetStatusOperation,
    mk_taskReadTrackingDataFormatOperation,
    mk_taskReadConnectionNotificationStatusOperation,
    mk_taskReadStorageDataNumberOperation,
    mk_taskReadLowBatteryReminderRulesOperation,
...
#pragma mark - Config
    ...
    mk_taskConfigButtonResetStatusOperation,
    mk_taskConfigTrackingDataFormatOperation,
    mk_taskConfigConnectionNotificationStatusOperation,
    mk_taskConfigLowBatteryReminderRulesOperation
};
