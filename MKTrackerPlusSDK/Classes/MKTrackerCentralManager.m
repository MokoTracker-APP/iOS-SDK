...
- (MKTrackerModel *)parseModelWith:(NSNumber *)rssi advDic:(NSDictionary *)advDic peripheral:(CBPeripheral *)peripheral {
    ...
    dataModel.isTrackerPlus = isPlus;
    ...
    dataModel.isCharging = [[state substringWithRange:NSMakeRange(3, 1)] isEqualToString:@"1"];
    if (isPlus) {
        //V2版本的Tracker设备
        dataModel.batteryPercentage = [MKBLEBaseSDKAdopter getDecimalWithHex:dataString range:NSMakeRange(14, 2)];
        dataModel.capacityPercentage = [MKBLEBaseSDKAdopter getDecimalWithHex:dataString range:NSMakeRange(16, 2)];
    }else {
        //V1版本的Tracker设备
