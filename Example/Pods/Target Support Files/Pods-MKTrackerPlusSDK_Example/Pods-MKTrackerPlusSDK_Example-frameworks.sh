...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MKBLEBaseModule/MKBLEBaseModule.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MKTrackerPlusSDK/MKTrackerPlusSDK.framework"
