...
- (void)whiteListButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(majorMinorFliterWhiteListState:index:)]) {
        [self.delegate majorMinorFliterWhiteListState:self.whiteListButton.isSelected index:self.dataModel.index];
    }
}
