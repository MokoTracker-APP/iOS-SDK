...
- (BOOL)configMacFilter {
    __block BOOL success = NO;
    [MKTrackerInterface configMacFilterStatus:self.macIson whiteList:self.macWhiteListIson mac:self.macValue sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configAdvNameFilterStatus {
    __block BOOL success = NO;
    [MKTrackerInterface configAdvNameFilterStatus:self.advNameIson whiteList:self.advNameWhiteListIson advName:self.advNameValue sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configProximityUUIDStatus {
    __block BOOL success = NO;
    [MKTrackerInterface configProximityUUIDFilterStatus:self.uuidIson whiteList:self.uuidWhiteListIson uuid:self.uuidValue sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configRawAdvDataStatus {
    __block BOOL success = NO;
    [MKTrackerInterface configRawAdvDataFilterStatus:self.rawDataIson whiteList:self.rawDataWhiteListIson rawAdvData:self.rawDataValue sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configMajorMaxMinValue {
    __block BOOL success = NO;
    [MKTrackerInterface configMajorFilterStatus:self.majorIson whiteList:self.majorWhiteListIson majorMinValue:[self.majorMinValue integerValue] majorMaxValue:[self.majorMaxValue integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configMinorMinMaxValue {
    __block BOOL success = NO;
    [MKTrackerInterface configMinorFilterStatus:self.minorIson whiteList:self.minorWhiteListIson minorMinValue:[self.minorMinValue integerValue] minorMaxValue:[self.minorMaxValue integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
