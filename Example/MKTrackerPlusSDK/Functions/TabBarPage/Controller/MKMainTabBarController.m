...
- (void)loadSubPages {
    ...
    advPage.tabBarItem.title = @"ADVERTISING";
    ...
    MKTrackerConfigController *trackerPage = [[MKTrackerConfigController alloc] init];
    trackerPage.tabBarItem.title = @"TRACKER";
    trackerPage.tabBarItem.image = LOADIMAGE(@"scannerTabBarItemUnselected", @"png");
    trackerPage.tabBarItem.selectedImage = LOADIMAGE(@"scannerTabBarItemSelected", @"png");
    UINavigationController *scannerNav = [[UINavigationController alloc] initWithRootViewController:trackerPage];
